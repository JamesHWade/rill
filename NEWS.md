...
* Hosted Rill now binds browser-capture credentials, captured Documents, standalone capture entries, and reading-copy selection to one Reader while retaining shared public Documents and immutable acquisition provenance (#21).
