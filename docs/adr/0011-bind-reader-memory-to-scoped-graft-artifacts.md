...
agent after a local or externally observed memory change shows a notice that
the current question starts a new conversation. Earlier displayed messages are
not passed to the new agent.
